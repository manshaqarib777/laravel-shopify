...
var LayoutBuilder = function () {
    ...
    var exporter = {
        ...
        startLoad: function (options) {
            $('#builder_export').addClass('k-spinner k-spinner--right k-spinner--sm k-spinner--light').find('span').text('Exporting...').closest('.k-form__actions').find('.btn').attr('disabled', true);
            toastr.info(options.title, options.message);
        },
        doneLoad: function () {
            $('#builder_export').removeClass('k-spinner k-spinner--right k-spinner--sm k-spinner--light').find('span').text('Export').closest('.k-form__actions').find('.btn').attr('disabled', false);
        },
    ...
    var preview = function () {
        $('[name="builder_submit"]').click(function (e) {
            e.preventDefault();
            var _self = $(this);
            $(_self).addClass('k-spinner k-spinner--right k-spinner--sm k-spinner--light').closest('.k-form__actions').find('.btn').attr('disabled', true);
    ...
    var verify = {
        reCaptchaVerified: function () {
            return $.ajax('../tools/builder/recaptcha.php?recaptcha', {
                ...
                grecaptcha.reset();
                $('#alert-message').removeClass('alert-success k-hide').addClass('alert-danger').html('Invalid reCaptcha validation');
            });
        },
        init: function () {
